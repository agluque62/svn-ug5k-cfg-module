...
function ug5kRecrCtrl($scope, $routeParams, $route, authservice, CfgService, ValidateService, transerv, MantService) {
    ...
    /* Mostrar Pesta�as Listas Blancas y Negras */
        ...
        switch (vm.pagina) {
            ...
            case 2:
                vm.vdata = [
                    ...
                    {   // 5
                        Name: isLocal() ? /*'Metodos BSS Disponibles:'*/transerv.translate('RCTRL_P02_BSSD') : /*'M�todo BSS Preferido:'*/transerv.translate('RCTRL_P02_BSSP'),
