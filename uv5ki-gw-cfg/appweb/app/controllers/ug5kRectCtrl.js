...
function ug5kRectCtrl($scope, $routeParams, $route, authservice, CfgService, ValidateService, transerv, MantService) {
    ...
    vm.show_rangos_ats = function () {
        ...
        if (vm.tdata == undefined)
            return false;
/* 20200706. En todas las l�neas telefonicas se muestran al menos los rangos de Origen.
        switch (vm.pagina) {
            case 0:
    ...
    function j2vdata() {
        ...
        switch (vm.pagina) {
            case 0:
                vm.vdata = [
                    ...
                    },
                    {
                        ...
                        Input: 1,
                        Inputs: [/*"No"*/transerv.translate('TCTRL_P00_NO'), /*"Si"*/transerv.translate('TCTRL_P00_SI')],
                        Show: function () { return vm.vdata[2].Value != "5"; },    // Todas las L�neas menos LCEN
                        Val: function () { return ""; }
                    }
                ];
                break;
                ...
                vm.vdata = [
                    ...
                    },
                    {
                        ...
                        Enable: function () {
                            ...
                            //20210301. Para REDAN se habilita la edici�n, y se deshabilita la opci�n para ULISES.
                            return authservice.global_enable([ADMIN_PROFILE, PCFG_PROFILE]);
                        },
                        Input: 1,
                        Inputs: [/*"No"*/transerv.translate('TCTRL_P00_NO'), /*"Si"*/transerv.translate('TCTRL_P00_SI')],
            ...
            case 4:                 // TODO...
                ...
                break;
            case 5:                 // 20200706. P�gina espec�fica para colaterales.
                vm.vdata = [
                    {
                        // 5 - 00
                        Name: /*'Tipo de Interfaz Telefonico:'*/transerv.translate('TCTRL_P00_ITF'),
