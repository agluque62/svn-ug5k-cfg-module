...
public:
	CommResTelef() {
		...
		idRed = "";
		idTroncal = "";
		/** 20180320. Nuevos Par�metros en interfaces analogicas */
		iTmLlamEntrante = 30;
		iTmDetFinLlamada = 6;
		...
		/** 20200703. Nuevos par�metros de l�neas Telef�nicas */
		iDetLineaAB = 0;
		iEnableNoED137 = 0;
...
public:
	virtual void jwrite(Writer<StringBuffer> &writer)
	{
		...
		write_key(writer, "itiporespuesta", itiporespuesta);	// Elementos A�adidos
	...
	virtual void jread(Value &base)
	{
		...
		read_key(base, "itiporespuesta", itiporespuesta);	// Elementos A�adidos
...
public:
	...
	string uri_remota;
	int superv_options;
	int itiporespuesta;	// Elementos A�adidos
