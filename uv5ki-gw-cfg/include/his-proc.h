...
/** Codigos de Eventos */
#define INCI_MPGP		150		// Modificaci�n de Par�metros Generales de Pasarela.			/ USER:GW:PAR=VALOR /
#define INCI_MRATS		151		// Modificaci�n Rutas ATS.										*/
#define INCI_MPHW		152		// Modificaci�n de Par�metros de Recurso Hardware.				/ USER:RECURSO:PAR=VALOR /
#define INCI_MPSW		153		// Modificaci�n de Par�metros L�gico de Recurso Hardware.		/ USER:RECURSO:PAR=VALOR /
#define INCI_GCFG		154		// Generaci�n de Configuraci�n por Defecto.						/ USER:CFG-NAME /
#define INCI_ACFG		155		// Activaci�n de Configuraci�n por Defecto.						/ USER:CFG-NAME /
#define INCI_DCFG		156		// Borrado de Configuraci�n por Defecto.						/ USER:CFG-NAME /
...
#define INCI_CGSW		180		// Carga de Versi�n Software.									*/ USER:VER=VERSION /
#define INCI_ATSW		181		// Activaci�n de Versi�n Software.								*/ USER:VER=VERSION /
#define INCI_RESET		182		// RESET Remoto.												/ USER /
#define INCI_BCLP		183		// Ejecuci�n de Bucle de Prueba.								*/ USER:BLUCE=IDBUCLE:COL1:COL2:RESULTADO /
#define INCI_BITE		184		// Ejecucion BITE desde Local.									/ USER /
#define INCI_SELPR		2100	// SP-Radio	Selecci�n Principal/Reserva							*/ USER:REC=RECURSO /
